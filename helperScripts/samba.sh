...
#############################################
echo "min protocol = SMB2" >> $smb_conf
echo "server min protocol = SMB2" >> $smb_conf
echo "client min protocol = SMB2" >> $smb_conf
echo "client max protocol = SMB2" >> $smb_conf
# can change to SMB3 if doesn't give points
echo "client signing = mandatory" >> $smb_conf
echo "server signing = mandatory" >> $smb_conf
echo "smb encrypt = mandatory" >> $smb_conf
